                  ...
                  return ListView(
                    children: <Widget>[
                      ...
                      PrizeBox(//รางวัลที่ 1
                          ...
                          snapshot.data['prizes'][0]['number'],1),
                        ...
                        children: <Widget>[
                          Expanded(
                            child: PrizeBox(
                                ...
                                snapshot.data['runningNumbers'][0]['number'],2),
                          ),
                          Expanded(
                            child: PrizeBox(
                                snapshot.data['runningNumbers'][1]['name'],
                                snapshot.data['runningNumbers'][1]['reward'],
                                snapshot.data['runningNumbers'][1]['number'],2),
                          ),
                        ],
                      ),
